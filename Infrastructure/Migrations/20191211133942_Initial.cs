    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalConvs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelConvs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelConvs_AdditionalConvs_AdditionalConvId",
                        column: x => x.AdditionalConvId,
                        principalTable: "AdditionalConvs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelConvs_Hotels_HotelId",
                        column: x => x.HotelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomConvs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomConvs_AdditionalConvs_AdditionalConvId",
                        column: x => x.AdditionalConvId,
                        principalTable: "AdditionalConvs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelConvs_AdditionalConvId",
                table: "HotelConvs",
                column: "AdditionalConvId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelConvs_HotelId",
                table: "HotelConvs",
                column: "HotelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomConvs_AdditionalConvId",
                table: "RoomConvs",
                column: "AdditionalConvId");
